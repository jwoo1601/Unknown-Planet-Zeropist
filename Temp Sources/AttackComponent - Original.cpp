...
#include "Registry/DefaultObjectProxy.h"
...
//FAttackSimulationResult::FAttackSimulationResult(bool bInAnyHit, class UAttackType *InAttackType) : bAnyHit(bInAnyHit), AttackType(InAttackType) { }
